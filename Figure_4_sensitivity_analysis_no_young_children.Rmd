...
vacc <- read.csv("../data/Vac_perc.csv")
...
comix_org <- read.csv("../data/processed_contact_data/young_children_removed/UK_CoMix.csv")
...
for (i in 1:length(comix_org$date)) {
  if (i < 4) {
    comix_org$mean.12.17.to.12.17[i] <- 0
    comix_org$mean.12.17.to.18.45[i] <- 0
    comix_org$mean.12.17.to.45.64[i] <- 0
    comix_org$mean.12.17.to.65.120[i] <- 0
    
    comix_org$mean.18.45.to.12.17[i] <- comix_org$X18.45.to.12.17[i]/comix_org$N.18.45[i]
    ...
    comix_org$mean.45.64.to.12.17[i] <- comix_org$X45.64.to.12.17[i]/comix_org$N.45.64[i]
    ...
    comix_org$mean.65.120.to.12.17[i] <- comix_org$X65.120.to.12.17[i]/comix_org$N.65.120[i]
    ...
    comix_org$mean.12.17.to.12.17[i] <- comix_org$X12.17.to.12.17[i]/comix_org$N.12.17[i]
    comix_org$mean.12.17.to.18.45[i] <- comix_org$X12.17.to.18.45[i]/comix_org$N.12.17[i]
    comix_org$mean.12.17.to.45.64[i] <- comix_org$X12.17.to.45.64[i]/comix_org$N.12.17[i]
    comix_org$mean.12.17.to.65.120[i] <- comix_org$X12.17.to.65.120[i]/comix_org$N.12.17[i]
...
for (i in 1:length(comix_org$date)) {
  comix_org$contact.12.17[i] <- comix_org$mean.12.17.to.12.17[i] + comix_org$mean.12.17.to.18.45[i] + comix_org$mean.12.17.to.45.64[i] + comix_org$mean.12.17.to.65.120[i]
  
  comix_org$contact.18.45[i] <- comix_org$mean.18.45.to.12.17[i] + comix_org$mean.18.45.to.18.45[i] + comix_org$mean.18.45.to.45.64[i] + comix_org$mean.18.45.to.65.120[i]
  
  comix_org$contact.45.64[i] <- comix_org$mean.45.64.to.12.17[i] + comix_org$mean.45.64.to.18.45[i] + comix_org$mean.45.64.to.45.64[i] + comix_org$mean.45.64.to.65.120[i]
  
  comix_org$contact.65.120[i] <- comix_org$mean.65.120.to.12.17[i] + comix_org$mean.65.120.to.18.45[i] + comix_org$mean.65.120.to.45.64[i] + comix_org$mean.65.120.to.65.120[i]
  
}

comix_org$"12-17" <- comix_org$contact.12.17 
...
for (i in 1:length(comix_org$date)) {
  comix_org$contact[i] <- (comix_org$contact.12.17[i]*comix_org$N.12.17[i] + comix_org$contact.18.45[i]*comix_org$N.18.45[i] + comix_org$contact.45.64[i]*comix_org$N.45.64[i] + comix_org$contact.65.120[i]*comix_org$N.65.120[i])/(comix_org$N.12.17[i] +comix_org$N.18.45[i] +comix_org$N.45.64[i] +comix_org$N.65.120[i])
}
```
...
vacc_comix$contact_model <- 2.1847 + 1.8505 * vacc_comix$perc_first_dose/100
```
...
date_other <- variants$date[which(variants$stratum == "Other")]
# Data other
dat_other <- data.frame("date" = date_other,
                        "prop_other" = variants$metric_value[which(variants$stratum == "Other")]/100)
...
var_data <- merge(var_data, dat_other, by = "date")
...
interpolated_values_other <- approx(x = dat_other$date, y = dat_other$prop_other, xout = new_dates)
...
data_inter <- data.frame(date = as.Date(interpolated_values_omic$x),
                         ...
                         alpha = interpolated_values_alpha$y+interpolated_values_other$y
)
...
data_comm$contact_model_2 <- (1 - data_comm$perc_first_dose/100)^2 * c_uu + 2 * (1 - data_comm$perc_first_dose/100) * (data_comm$perc_first_dose/100) * c_uv + (data_comm$perc_first_dose/100)^2 * c_vv
...
for (i in 1:length(data_comm$perc_first_dose)) {
  ...
  data_comm$Delta_R_homo_alpha[i] <- (data_comm$contact_model_2[i]/c_uu) * (1 - (1 - psi_alpha) * data_comm$perc_first_dose[i]/100)
...
for (i in 1:length(data_comm$perc_first_dose)) {
  ...
  data_comm$Delta_R_homo_omicron[i] <- (data_comm$contact_model_2[i]/c_uu) * (1 - (1 - psi_omicron) * data_comm$perc_first_dose[i]/100)
...
alpha <- ggplot(data_comm, aes(x = perc_first_dose)) +
  ...
  labs(x = "", y = expression(tilde(R)[eff]), colour = "model", title = expression("Alpha")) +
...
all <- ggplot(data_comm, aes(x = date)) +
  ...
  labs(x = "Date", y = expression(tilde(R)[eff]), colour = "Model") +
...
```{r}
ggsave('Figures/Fig_4_sensitivity_no_young_children.png',
  plot = get_last_plot(),
  device = png,
  path = '.',
  width = 2250,
