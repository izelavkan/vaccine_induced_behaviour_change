...
```{r}
# CoMix data
comix_org <- read.csv("/Users/df23614/Desktop/vaccine_model/github_codes/data/UK_CoMix.csv")
...
```{r}
variants <- read.csv("/Users/df23614/Desktop/vaccine_model/github_codes/data/variants.csv")
