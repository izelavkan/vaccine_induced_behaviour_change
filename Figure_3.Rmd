...
folder_path <- "../data/processed_contact_data/all_ages/bootstrap_samples"
...
vacc_contact$contact_model <- 1.68 * (1-vacc_contact$vacc/100)^2 + 5.56 * 2 * (1-vacc_contact$vacc/100) * (vacc_contact$vacc/100) + 4.91 * (vacc_contact$vacc/100)^2

vacc_contact$contact_model_lower <- 1.05 * (1-vacc_contact$vacc/100)^2 + 4.45 * 2 * (1-vacc_contact$vacc/100) * (vacc_contact$vacc/100) + 4.28 * (vacc_contact$vacc/100)^2

vacc_contact$contact_model_upper <- 2.28 * (1-vacc_contact$vacc/100)^2 + 6.70 * 2 * (1-vacc_contact$vacc/100) * (vacc_contact$vacc/100) + 5.51 * (vacc_contact$vacc/100)^2
```
